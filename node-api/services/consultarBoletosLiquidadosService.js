...
async function consultarBoletosLiquidados(
  payload,
  CAMINHO_CRT,
  SENHA_CRT,
  CLIENTID,
  ...
  try {
    const url =
      "https://openapisandbox.prebanco.com.br/boleto/cobranca-lista/v1/listar";
...
module.exports = consultarBoletosLiquidados;
