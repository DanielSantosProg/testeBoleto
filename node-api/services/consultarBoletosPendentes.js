...
async function consultarBoletosPendentes(
  payload,
  CAMINHO_CRT,
  SENHA_CRT,
  CLIENTID,
  ...
  try {
    const url =
      "https://openapisandbox.prebanco.com.br/boleto/cobranca-pendente/v1/listar";
...
module.exports = consultarBoletosPendentes;
